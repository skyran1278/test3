...
export class Schema1729582334218 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "domain0024" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "domain0024001" integer, CONSTRAINT "PK_0dbef6a3fa0601bdf27cdd2a29c" PRIMARY KEY ("id")); COMMENT ON COLUMN "domain0024"."domain0024001" IS 'domain0024001'`);
        await queryRunner.query(`CREATE TABLE "domain0025" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "domain0025001" integer, CONSTRAINT "PK_9a3b1cbbdbd37416e5f4782d796" PRIMARY KEY ("id")); COMMENT ON COLUMN "domain0025"."domain0025001" IS 'domain0025001'`);
        await queryRunner.query(`CREATE TABLE "domain0021" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "domain0021001" integer, "parentId" uuid, "mpath" character varying DEFAULT '', CONSTRAINT "PK_80653543e4fa454aacc20f53467" PRIMARY KEY ("id")); COMMENT ON COLUMN "domain0021"."domain0021001" IS 'domain0021001'; COMMENT ON COLUMN "domain0021"."parentId" IS 'parent ID'`);
        ...
        await queryRunner.query(`CREATE TABLE "domain0024_domain0025s_domain0025" ("domain0024Id" uuid NOT NULL, "domain0025Id" uuid NOT NULL, CONSTRAINT "PK_55eec2df182e6762cd15432db64" PRIMARY KEY ("domain0024Id", "domain0025Id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_734779f00ef4c0020b8864a212" ON "domain0024_domain0025s_domain0025" ("domain0024Id") `);
        await queryRunner.query(`CREATE INDEX "IDX_9c345e943397192cf9bfab163a" ON "domain0024_domain0025s_domain0025" ("domain0025Id") `);
        ...
        await queryRunner.query(`ALTER TABLE "domain0024" ADD CONSTRAINT "FK_85160667d17e012f47f3bf05bf1" FOREIGN KEY ("createdUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0024" ADD CONSTRAINT "FK_c90d61b8d3cd7a79fb79a492269" FOREIGN KEY ("updatedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0024" ADD CONSTRAINT "FK_5197b3bc797ea37d4a7eadc396f" FOREIGN KEY ("deletedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0025" ADD CONSTRAINT "FK_b7a55aa69fc65396d3f86ebee59" FOREIGN KEY ("createdUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0025" ADD CONSTRAINT "FK_290e83ad65bd13a7ac1badb9fbd" FOREIGN KEY ("updatedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0025" ADD CONSTRAINT "FK_c69d5fdf5b7a0c7cdcf721efbb1" FOREIGN KEY ("deletedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0021" ADD CONSTRAINT "FK_e783852372fdf72b9ad6051cd88" FOREIGN KEY ("createdUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0021" ADD CONSTRAINT "FK_35d50864d9ea53e19e42cb544d0" FOREIGN KEY ("updatedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0021" ADD CONSTRAINT "FK_8519ab43048c200e8e1cd157167" FOREIGN KEY ("deletedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "domain0021" ADD CONSTRAINT "FK_23587b34fe7e64b10f4684e6db8" FOREIGN KEY ("parentId") REFERENCES "domain0021"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "domain0024_domain0025s_domain0025" ADD CONSTRAINT "FK_734779f00ef4c0020b8864a2120" FOREIGN KEY ("domain0024Id") REFERENCES "domain0024"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "domain0024_domain0025s_domain0025" ADD CONSTRAINT "FK_9c345e943397192cf9bfab163a0" FOREIGN KEY ("domain0025Id") REFERENCES "domain0025"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "domain0024_domain0025s_domain0025" DROP CONSTRAINT "FK_9c345e943397192cf9bfab163a0"`);
        await queryRunner.query(`ALTER TABLE "domain0024_domain0025s_domain0025" DROP CONSTRAINT "FK_734779f00ef4c0020b8864a2120"`);
        ...
        await queryRunner.query(`ALTER TABLE "domain0021" DROP CONSTRAINT "FK_23587b34fe7e64b10f4684e6db8"`);
        await queryRunner.query(`ALTER TABLE "domain0021" DROP CONSTRAINT "FK_8519ab43048c200e8e1cd157167"`);
        await queryRunner.query(`ALTER TABLE "domain0021" DROP CONSTRAINT "FK_35d50864d9ea53e19e42cb544d0"`);
        await queryRunner.query(`ALTER TABLE "domain0021" DROP CONSTRAINT "FK_e783852372fdf72b9ad6051cd88"`);
        await queryRunner.query(`ALTER TABLE "domain0025" DROP CONSTRAINT "FK_c69d5fdf5b7a0c7cdcf721efbb1"`);
        await queryRunner.query(`ALTER TABLE "domain0025" DROP CONSTRAINT "FK_290e83ad65bd13a7ac1badb9fbd"`);
        await queryRunner.query(`ALTER TABLE "domain0025" DROP CONSTRAINT "FK_b7a55aa69fc65396d3f86ebee59"`);
        await queryRunner.query(`ALTER TABLE "domain0024" DROP CONSTRAINT "FK_5197b3bc797ea37d4a7eadc396f"`);
        await queryRunner.query(`ALTER TABLE "domain0024" DROP CONSTRAINT "FK_c90d61b8d3cd7a79fb79a492269"`);
        await queryRunner.query(`ALTER TABLE "domain0024" DROP CONSTRAINT "FK_85160667d17e012f47f3bf05bf1"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9c345e943397192cf9bfab163a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_734779f00ef4c0020b8864a212"`);
        await queryRunner.query(`DROP TABLE "domain0024_domain0025s_domain0025"`);
        ...
        await queryRunner.query(`DROP TABLE "domain0021"`);
        await queryRunner.query(`DROP TABLE "domain0025"`);
        await queryRunner.query(`DROP TABLE "domain0024"`);
