...
import { CreateDomain2Output } from './mutation/create-domain2.output';
import { RemoveDomain2Input } from './mutation/remove-domain2.input';
import { RemoveDomain2Output } from './mutation/remove-domain2.output';
import { UpdateDomain2Input } from './mutation/update-domain2.input';
import { UpdateDomain2Output } from './mutation/update-domain2.output';
import { Domain2PageArgs } from './query/domain2-page.args';
import { Domain2Page } from './query/domain2-page.type';
