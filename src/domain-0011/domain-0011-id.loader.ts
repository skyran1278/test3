...
export class Domain0011IdLoader extends DataLoader<string, Maybe<Domain0011>> {
  constructor(
    @InjectRepository(Domain0011)
    private readonly repo: Repository<Domain0011>,
  ) {
    super(async (keys: readonly string[]): Promise<Maybe<Domain0011>[]> => {
