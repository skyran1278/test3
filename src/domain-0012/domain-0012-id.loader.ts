...
export class Domain0012IdLoader extends DataLoader<string, Maybe<Domain0012>> {
  constructor(
    @InjectRepository(Domain0012)
    private readonly repo: Repository<Domain0012>,
  ) {
    super(async (keys: readonly string[]): Promise<Maybe<Domain0012>[]> => {
