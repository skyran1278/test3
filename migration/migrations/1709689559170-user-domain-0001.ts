...
export class UserDomain00011709689559170 implements MigrationInterface {
  name = 'UserDomain00011709689559170';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(sql`
      CREATE TABLE "domain0001" (
        ...
        "updatedUserId" uuid,
        "deletedUserId" uuid,
        "domain0001001" integer,
        CONSTRAINT "PK_fc0aa49f88c9f4ec4b79a5c11ba" PRIMARY KEY ("id")
      );

      COMMENT ON COLUMN "domain0001"."domain0001001" IS 'domain0001001'
    `);
    await queryRunner.query(sql`
      CREATE TABLE "user" (
        "id" uuid NOT NULL DEFAULT uuid_generate_v4 (),
    ...
    `);
    await queryRunner.query(sql`
      ALTER TABLE "domain0001" ADD CONSTRAINT "FK_06e43f38c154f2fb12481bd81d0" FOREIGN KEY ("createdUserId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
    await queryRunner.query(sql`
      ALTER TABLE "domain0001" ADD CONSTRAINT "FK_eed51416839377f38c988530cab" FOREIGN KEY ("updatedUserId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
    await queryRunner.query(sql`
      ALTER TABLE "domain0001" ADD CONSTRAINT "FK_96ca2ef35fe71016ae87158a0b8" FOREIGN KEY ("deletedUserId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
    await queryRunner.query(sql`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(sql`DROP TABLE "domain0001"`);
  }
}
