...
export class Domain2Domain31711819664999 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "domain2" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "domain2001" integer, CONSTRAINT "PK_62c76f3a9c016504bca07e761f6" PRIMARY KEY ("id")); COMMENT ON COLUMN "domain2"."domain2001" IS 'domain2001'`);
        ...
        await queryRunner.query(`ALTER TABLE "domain3" ADD CONSTRAINT "FK_5d756bbfcf3f2a4f9ec1af7803c" FOREIGN KEY ("domain2Id") REFERENCES "domain2"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
