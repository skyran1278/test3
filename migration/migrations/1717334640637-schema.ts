...
export class Schema1717334640637 implements MigrationInterface {
    name = 'Schema1717334640637'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "department" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "name" character varying(20) NOT NULL, "parentId" uuid, "mpath" character varying DEFAULT '', CONSTRAINT "PK_9a2213262c1593bffb581e382f5" PRIMARY KEY ("id")); COMMENT ON COLUMN "department"."name" IS '部門名稱'; COMMENT ON COLUMN "department"."parentId" IS '上層部門 ID'`);
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdUserId" uuid, "updatedUserId" uuid, "deletedUserId" uuid, "departmentId" uuid NOT NULL, "userId" uuid NOT NULL, "roleId" uuid NOT NULL, "mpath" character varying DEFAULT '', "parentId" uuid, CONSTRAINT "UQ_fd5c079a99059924291ecc93123" UNIQUE ("departmentId", "userId"), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id")); COMMENT ON COLUMN "employee"."departmentId" IS '部門 ID'; COMMENT ON COLUMN "employee"."userId" IS 'User ID'; COMMENT ON COLUMN "employee"."roleId" IS '部門職務 ID'`);
        ...
        await queryRunner.query(`ALTER TABLE "department" ADD CONSTRAINT "FK_8b2a29610d431eb3587c8f8bac8" FOREIGN KEY ("createdUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "department" ADD CONSTRAINT "FK_a5d4b1a640b284b3b46ed0200d3" FOREIGN KEY ("updatedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "department" ADD CONSTRAINT "FK_7ac8a319117d30393a41ed63a25" FOREIGN KEY ("deletedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "employee" ADD CONSTRAINT "FK_a8b9e1e5cb55a90e701f21e8fd1" FOREIGN KEY ("createdUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee" ADD CONSTRAINT "FK_22caf5a14861334047c0faa69aa" FOREIGN KEY ("updatedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee" ADD CONSTRAINT "FK_feb9b759d03dbe6a84987e4818f" FOREIGN KEY ("deletedUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "employee" DROP CONSTRAINT "FK_feb9b759d03dbe6a84987e4818f"`);
        await queryRunner.query(`ALTER TABLE "employee" DROP CONSTRAINT "FK_22caf5a14861334047c0faa69aa"`);
        await queryRunner.query(`ALTER TABLE "employee" DROP CONSTRAINT "FK_a8b9e1e5cb55a90e701f21e8fd1"`);
        ...
        await queryRunner.query(`ALTER TABLE "department" DROP CONSTRAINT "FK_7ac8a319117d30393a41ed63a25"`);
        await queryRunner.query(`ALTER TABLE "department" DROP CONSTRAINT "FK_a5d4b1a640b284b3b46ed0200d3"`);
        await queryRunner.query(`ALTER TABLE "department" DROP CONSTRAINT "FK_8b2a29610d431eb3587c8f8bac8"`);
