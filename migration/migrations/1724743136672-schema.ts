...
export class Schema1724743136672 implements MigrationInterface {
    name = 'Schema1724743136672'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "domain0024_domain0025s_domain0025" ADD CONSTRAINT "FK_9c345e943397192cf9bfab163a0" FOREIGN KEY ("domain0025Id") REFERENCES "domain0025"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
